...
function App() {
  ...
  const about = {
    title: "About",
    description:
      "Hello! I'm Jaya Janyanii, a tech enthusiast with a bachelor's degree in Information Technology from Solapur University, Maharashtra. Eager to contribute my skills in either Bangalore/Pune.",
    image: img5,
